...
const internalNav = [
  ...
  { to: '/internal/sla', label: 'SLA Dashboard', icon: Target },
  { to: '/internal/errors', label: 'Error Intelligence', icon: AlertTriangle },
  { to: '/internal/triggers', label: 'Trigger Management', icon: Radar },
  { to: '/internal/ownership', label: 'Ownership', icon: Shield },
  { to: '/internal/rca', label: 'Root Cause Analytics', icon: GitBranch },
  { to: '/internal/executive', label: 'Executive', icon: FileBarChart },
  { to: '/internal/audit', label: 'Audit Logs', icon: ScrollText },
  { to: '/internal/reports', label: 'Reports', icon: ClipboardList },
